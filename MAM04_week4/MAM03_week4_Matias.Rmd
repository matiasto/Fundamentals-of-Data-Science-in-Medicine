...
generate_patient_plots <- function(patient_id) {
  ...
  plot(dyn_pred_gfr, conf.int=TRUE, fill.area=TRUE, col.area="grey", include.y=TRUE)
  ...
  plot(dyn_pred_creat, conf.int=TRUE, fill.area=TRUE, col.area="grey", include.y=TRUE)
  ...
  plot(dyn_pred_map, conf.int=TRUE, fill.area=TRUE, col.area="grey", include.y=TRUE)
}
